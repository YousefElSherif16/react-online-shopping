...
const NotificationBar = () => {
  return (
    <Container fluid>
      <Row className="notification-bar d-flex justify-content-center align-items-center">
        <div className="col-0 col-sm-3 justify-content-end"></div>
        <div className="col-9 col-sm-6 d-flex justify-content-end justify-content-sm-center align-items-center gap-2 h-100">
          <div className="notification-bar-text d-flex align-items-center gap-2 ">
            <svg
            ...
            <p className="m-0">30% off storewide — Limited time!</p>
          </div>
          <div className="notification-bar-button d-md-flex d-none justify-content-center align-items-center gap-1">
            <a href="#" alt="">
              Shop Now
            </a>
            <a href="#">
        ...
        <div className=" notification-bar-close col-3 col-sm-3 d-flex justify-content-md-end justify-content-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
