  ...
  return (
    <Container>
      <div className="d-flex flex-wrap justify-content-between ">
        <div className="value-card my-4 mx-2 p-md-5 p-4">
          <div>
            <svg
          ...
          <div>
            ...
            <p className="caption">Order above $200</p>
          </div>
        </div>
        <div className="value-card my-4 mx-2 p-md-5 p-4">
          <div>
          ...
          <div>
            ...
            <p className="caption">30 days guarantee</p>
          </div>
        </div>
        <div className="value-card my-4 mx-2 p-md-5 p-4">
          <div>
          ...
          <div>
            ...
            <p className="caption">Secured by Stripe</p>
          </div>
        </div>
        <div className="value-card my-4 mx-2 p-md-5 p-4">
          <div>
          ...
          <div>
            ...
            <p className="caption">Phone and Email support</p>
          </div>
        </div>
      </div>
    </Container>
